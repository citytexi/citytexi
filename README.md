...
- 2020년부터 프로그래밍, 안드로이드 관련 공부를 시작하여 안드로이드 관련된 다양한 프로젝트를 경험하면서 개발 경험을 쌓았습니다.
- 개발 과정에서 만나는 다양한 문제들에 몰입하여 해결하는 행동 자체에 의미를 두고 실패하거나 누군가의 경험을 통해 도움을 받더라도 경험을 통해 성장하는 나를 만들어 가고 있습니다.
- 새로운 기술과 트렌드에 관심을 두며 KMP, CMP 등 다양한 지식을 습득했고 더 나아가 이를 공유하는 개발자가 되는 것을 희망합니다.
